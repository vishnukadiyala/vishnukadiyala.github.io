...
\textbf{Under Review}
\begin{itemize}
  \item \textbf{V.\ P.\ Kadiyala}. \textit{Implicit Coordination via Attention-Based Latent Belief Updates in Decentralized Partially Observable Multi-Agent Systems.} Under review at ICML 2026.
\end{itemize}
