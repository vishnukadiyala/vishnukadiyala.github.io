    ...
    <section id="teaching" className="section fade-in">
      ...
      <div className="teaching-entry">
        ...
        <ul className="teaching-details">
          <li>
            Led weekly labs on digital logic, assembly-level reasoning, and
            hardware/software interface fundamentals.
          </li>
          <li>
            Developed lab documentation and troubleshooting/debugging workflows for
            novice builders.
          </li>
        </ul>
      </div>
